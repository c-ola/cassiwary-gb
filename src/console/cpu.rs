        ...
        match instr {
            ...
            Add(_) | Sub(_) | And(_) | Or(_) | Adc(_) | Sbc(_) | Xor(_) | Cmp(_) | Addn | Subn | Andn | Orn | Adcn | Sbcn | Xorn | Cmpn => {
                let n = match instr {
                    ...
                    Add(r) | Sub(r) | And(r) | Or(r) | Adc(r) | Sbc(r) | Xor(r) | Cmp(r) => self.get_reg_or_mem(r, memory),
            ...
            CB => {
                let prefix_instr = self.cb_prefix(memory);
    ...
    pub fn execute_prefix(&mut self, instr: Instruction, memory: &Memory) {
        match instr {
            RLCr(r) | RRCr(r) | RLr(r) | RRr(r) | SLAr(r) | SRAr(r) | SRLr(r) => {
                ...
                match instr {
                    RLCr(r) | RLr(r) | SLAr(r) => rv = rv << 1,
                    RRCr(r) | RRr(r) | SRAr(r) | SRLr(r) => rv = rv >> 1,
                    _ => (),
                }
